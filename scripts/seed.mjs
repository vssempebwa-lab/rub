...
const USERS = [
  ...
  { email: 'photographer@rubshoots.com', fullName: 'Kwame Asante', role: 'photographer', phone: '+233 24 111 2233', bio: 'Lead wedding and portrait photographer with 8 years of experience.' },
  { email: 'client1@rubshoots.com', fullName: 'Sarah Addo', role: 'client', phone: '+233 20 555 1234' },
  { email: 'client2@rubshoots.com', fullName: 'Michael Osei', role: 'client', phone: '+233 27 888 4567' },
  { email: 'client3@rubshoots.com', fullName: 'Ama Mensah', role: 'client', phone: '+233 55 333 9876' },
];
...
async function seedEvents({ photographerId, clientIds, categories }) {
  ...
  const events = [
    ...
    },
    {
      ...
      description: 'Annual corporate awards gala for TechGhana Ltd.',
    ...
    },
    {
      ...
      location: 'Accra Fashion Week Studio',
...
async function seedBookings() {
  const bookings = [
    { client_name: 'Grace Boateng', client_email: 'grace@example.com', client_phone: '+233 24 000 1111', event_date: '2026-08-15', event_type: 'Wedding', package_name: 'Gold', message: 'Looking for full day wedding coverage at Royal Senchi Resort.', status: 'pending' },
    { client_name: 'David Kwarteng', client_email: 'david@example.com', client_phone: '+233 20 000 2222', event_date: '2026-06-20', event_type: 'Corporate Event', package_name: 'Premium', message: 'Annual company conference with 300 attendees.', status: 'pending' },
    { client_name: 'Sarah Addo', client_email: 'client1@rubshoots.com', client_phone: '+233 20 555 1234', event_date: '2025-11-15', event_type: 'Wedding', package_name: 'Gold', message: 'Beach wedding at Labadi.', status: 'confirmed' },
    { client_name: 'Michael Osei', client_email: 'client2@rubshoots.com', client_phone: '+233 27 888 4567', event_date: '2025-05-08', event_type: 'Corporate Event', package_name: 'Premium', message: 'Corporate gala photography.', status: 'completed' },
    { client_name: 'Efua Ansah', client_email: 'efua@example.com', client_phone: '+233 55 000 3333', event_date: '2026-03-10', event_type: 'Portrait', package_name: 'Silver', message: 'Changed plans, no longer needed.', status: 'cancelled' },
    { client_name: 'Kofi Mensah', client_email: 'kofi@example.com', client_phone: '+233 26 000 4444', event_date: '2026-09-01', event_type: 'Graduation', package_name: 'Silver', message: 'University of Cape Coast graduation photos.', status: 'pending' },
  ];
...
async function seedTestimonials() {
  ...
  await supabase.from('testimonials').insert([
    ...
    { client_name: 'TechGhana Ltd', client_title: 'Corporate Partner', content: 'Rub Shoots has been our go-to for all corporate events. Reliable, professional, and consistently excellent.', rating: 5, is_featured: true },
  ]);
}
